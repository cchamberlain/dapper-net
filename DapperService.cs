...
namespace Dapper.Net
{
    ...
    public class DapperPatterns<TModel, TKey> : IDapperPatterns<TModel, TKey>
    {
        ...
        public TModel Get(TKey id) { throw new NotImplementedException(); }
        public TModel GetSingle(TKey id) { throw new NotImplementedException(); }
        public IEnumerable<TModel> Get(SqlWhere clause) {
            throw new NotImplementedException();
        }

        public IEnumerable<TModel> Get(ArgsMap constraints) { throw new NotImplementedException(); }
        public TModel Put(TModel entity) { throw new NotImplementedException(); }
        public TKey Post(TModel entity) { throw new NotImplementedException(); }
        public bool Delete(TKey id) { throw new NotImplementedException(); }
    }
...
public abstract class DapperService {
    ...
    protected DapperService(string connectionString, ICacheProvider cacheProvider = null) {
        CacheProvider = cacheProvider ?? DefaultCacheProvider.Instance.Value;
